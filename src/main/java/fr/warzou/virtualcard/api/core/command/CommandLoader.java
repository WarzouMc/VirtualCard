...
import fr.warzou.virtualcard.utils.exception.command.CommandAttributeMissingException;
...
public class CommandLoader {
    ...
    public CommandLoader(@NotNull Card api) {
        this.api = api;
    }
    ...
    public void load(@NotNull InputStream stream) {
        ...
        commandList.forEach(element -> {
            ...
            this.api.getCommandRegister().addCommand(commandBuilder.build());
        });
    }
